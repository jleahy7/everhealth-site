...
class MainContent{
  ...
  function createAcct2(){
    ...
    echo "</select>";
    echo "<input class='form-input-text text-input-medium left' type='text' id='firstName' name='firstName' placeholder='First Name'>";
    echo "<input class='form-input-text text-input-medium right' type='text' id='lastName' name='lastName' placeholder='Last Name'>";
  ...
  function createAcct3(){
    ...
    echo "<select  class='credit-info expire-month' name='expire-month' id='expire-month'>";
    ...
    echo "</select>";
    echo "<select class='credit-info expire-year'name='expire-year' id='expire-year'>";
    ...
    echo "<input id='address' name='address' class='form-input-text text-input-large' placeholder='Address Line 1'>";
    echo "<input id='address2' name='address2' class='form-input-text text-input-large' placeholder='Address Line 2'>";
    echo "<input id='city' name='city' class='form-input-text expire-month' placeholder='City'>";
    echo "<select class='credit-info expire-year same-line' name='state' id='state'>";
    echo "<option value=''>State</option>";
    foreach (Info::get_states() as $key => $value) {
        echo "<option value='" . $value . "'>" . $value . " (" . $key . ")</option>";;
    }
    echo "</select>";
    echo "<input id='zip' name='zip' class='form-input-text text-input-large' placeholder='Zip Code' maxlength='12'>";
    echo "<select id='plan-select' class='large-wide' name='chosen-plan'>";
    foreach (Info::get_plans() as $key => $value) {
        if($key == $planType){
          $tt = "<option value='" . $key . "' selected='selected'>" . $value ."</option>";
  ...
  function signIn(){
    ...
    echo "<input class='form-input-text text-input-large' id='password' type='text' name='password' placeholder=' Password'>";
  ...
  function changePass(){
    ...
    if(isset($_GET['passwordLengthError']) && $_GET['passwordLengthError']){
      ...
      echo "<p id='signin-error-p'><srtong>Error: Wrong current password.</strong></p>";
    }
