...
class Header{
  ...
  function __construct($_page, $_info){
    ...
    echo "<link rel='shortcut icon' href='assets/favicon.ico' type='image/x-icon'/ >";
    ...
    echo "<script src='js/jquery-Mask-Plugin.js'></script>";
    echo "<script src='js/TweenLite.min.js'></script>";
